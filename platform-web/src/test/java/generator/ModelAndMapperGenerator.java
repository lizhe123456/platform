...
import static com.tjzy.platform.model.constant.Constant.MAPPER_PACKAGE;
import static com.tjzy.platform.model.constant.Constant.MODEL_PACKAGE;
...
//			cfg.validate();
		...
		if (StringHelper.isNullOrEmpty(modelName)) {

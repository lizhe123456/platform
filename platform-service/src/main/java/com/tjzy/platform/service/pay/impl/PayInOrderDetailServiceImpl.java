...
import com.tjzy.platform.service.pay.PayInOrderDetailService;
...
@Service
@Transactional
public class PayInOrderDetailServiceImpl extends PayBaseServiceImpl<PayInOrderDetailMapper,PayInOrderDetail> implements
        PayInOrderDetailService {

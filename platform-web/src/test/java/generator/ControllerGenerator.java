...
import static com.tjzy.platform.model.constant.Constant.BASE_PACKAGE;
...
public class ControllerGenerator extends CodeGeneratorBaseTool {
	...
	public static void genController(String tableName, String modelName, String sign) {
		try {
            ...
            String modelNameUpperCamel = StringHelper.isNullOrEmpty(modelName) ? tableNameConvertUpperCamel(tableName) : modelName;
            data.put("sign", sign);
            data.put("baseRequestMapping", StringHelper.toLowerCaseFirstOne(modelNameUpperCamel));

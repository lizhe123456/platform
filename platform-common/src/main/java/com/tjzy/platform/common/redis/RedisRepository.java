...
public class RedisRepository {
     ...
     * Logger
     */
    private static final Logger _log = LoggerFactory.getLogger(RedisRepository.class);
    ...
    public void setExpire(final byte[] key, final byte[] value, final long time) {
        redisTemplate.execute((RedisCallback<Long>) connection -> {
            ...
            _log.info("[redisTemplate redis]放入 缓存 url : {} ========缓存时间为{}秒",key,value);
            return 1L;
        });
    }
    ...
    public void setExpire(final String key, final String value, final long time) {
        redisTemplate.execute((RedisCallback<Long>) connection -> {
            ...
            _log.info("[redisTemplate redis]放入 缓存  url:{} ========缓存时间为{}秒", key, time);
            return 1L;
        });
    }
    ...
    public void set(final String[] keys, final String[] values) {
        redisTemplate.execute((RedisCallback<Long>) connection -> {
            ...
            for (int i = 0; i < keys.length; i++) {
                ...
                _log.info("[redisTemplate redis]放入 缓存  url:{}", keys[i]);
            }
            return 1L;
        });
    }
    ...
    public void set(final String key, final String value) {
        redisTemplate.execute((RedisCallback<Long>) connection -> {
            ...
            byte[] values = serializer.serialize(value);
            connection.set(keys, values);
            _log.info("[redisTemplate redis]放入 缓存  url:{}", key);
            return 1L;
        });
    }
    ...
    public byte[] get(final byte[] key) {
        ...
        _log.info("[redisTemplate redis]取出 缓存  url:{} ", key);
        return result;
    }
    ...
    public Map<String, String> getKeysValues(final String keyPatten) {
        _log.info("[redisTemplate redis]  getValues()  patten={} ", keyPatten);
    ...
    public void putHashValue(String key, String hashKey, String hashValue) {
        _log.info("[redisTemplate redis]  putHashValue()  key={},hashKey={},hashValue={} ", key, hashKey, hashValue);
    ...
    public Object getHashValues(String key, String hashKey) {
        _log.info("[redisTemplate redis]  getHashValues()  key={},hashKey={}", key, hashKey);
    ...
    public void delHashValues(String key, Object... hashKeys) {
        _log.info("[redisTemplate redis]  delHashValues()  key={}", key);
    ...
    public Map<String, String> getHashValue(String key) {
        _log.info("[redisTemplate redis]  getHashValue()  key={}", key);

...
import static com.tjzy.platform.model.constant.Constant.CONTROLLER_PACKAGE;
import static com.tjzy.platform.model.constant.Constant.SERVICE_IMPL_PACKAGE;
import static com.tjzy.platform.model.constant.Constant.SERVICE_PACKAGE;
...
public class CodeGeneratorBaseTool {
	...
	protected static String getDefModelName(String tableName) {
		...
		for (int i = 2; i < strs.length; i++) {
			sb.append(StringHelper.toUpperCaseFirstOne(strs[i].toLowerCase()));
		}
		return sb.toString();
	}
